    ...
    <div class="main-wrapper main-wrapper-1">
        ...
        <div class="main-sidebar sidebar-style-2">
            <aside id="sidebar-wrapper">
                ...
                <ul class="sidebar-menu">
                    <li class="menu-header">Shop Item</li>
                    <li class="dropdown">
                        <a class="nav-link has-dropdown"><i class="fas fa-cart-plus"></i>
                            <span>Category</span></a>
                        <ul class="dropdown-menu">
                            @php
                                $listOfCategory = CategoryController::getAllAsData()
                            @endphp
                            @foreach($listOfCategory as $data)
                                <li class="@yield('menu-'.$data->id)"><a class="nav-link" href="/home/{{$data->id}}">
                    ...
                    <li class="dropdown">
                        ...
                        <ul class="dropdown-menu">
                            <li><a class="nav-link" href="forms-editor.html">Cart</a></li>
                            <li><a class="nav-link" href="forms-validation.html">History Transaction</a></li>
                        </ul>
                    </li>
                    <li class="menu-header">Profile</li>
                    <li class="dropdown">
                        <a class="nav-link has-dropdown"><i class="far fa-file-alt"></i>
                            <span>My Item</span></a>
                        <ul class="dropdown-menu">
                            <li class="@yield('menu-product')"><a class="nav-link" href="/product">Manage Item</a></li>
                        </ul>
                    </li>
                </ul>
        ...
        <footer class="main-footer">
            <div class="footer-left">
                ...
                Created With ❤️ In Surabaya by <a href="https://anxdre.my.id/">Andre Setiawan A.</a>
            </div>
